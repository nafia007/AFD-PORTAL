  ...
  return (
    <div className="space-y-6">
      <div className="text-center">
        <h2 className="text-2xl font-bold text-foreground mb-2">IP Trading Coming Soon</h2>
        <p className="text-muted-foreground">Film tokenization and trading features will be available in the profile section.</p>
      </div>
    </div>
  );
};
